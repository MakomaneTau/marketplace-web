...
export default function SellerAnalyticsPage() {
  ...
  const load = useCallback(() => apiRequest<Analytics>(`/seller/analytics?days=${days}`, { auth: true }).then(setData).catch((requestError) => {
    if (
